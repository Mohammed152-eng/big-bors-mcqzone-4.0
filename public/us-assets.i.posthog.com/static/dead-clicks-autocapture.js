!(function () {
        ...
        n = {
          k(r) {
            if (i && (i.POSTHOG_DEBUG || e) && !f(i.console) && i.console) {
              for (
                var n =
                    ("__rrweb_original__" in i.console[r])
                      ? i.console[r].__rrweb_original__
                      : i.console[r],
                  a = arguments.length,
  ...
  function A(t, i) {
    if (!p(t))
      if (h(t)) t.forEach(i);
      else if (g(t)) t.forEach((t, r) => i(t, r));
      else for (var r in t) l.call(t, r) && i(t[r], r);
  }
  var x = function (t) {
    for (
      ...
      r[e - 1] = arguments[e];
    for (var n of r) for (var a in n) void 0 !== n[a] && (t[a] = n[a]);
    return t;
  };
  function C(t) {
  ...
  var F = (t) => !t || S(t, "html") || !E(t),
    I = (t, r) => {
      ...
      return { parentIsUsefulElement: e, targetElementList: n };
    };
  function W(t) {
    for (
      var i = new Set(), r = 0, e = t;
      e.parentNode && !S(e, "body");
      e = e.parentNode
    ) {
      if (r++ >= L || i.has(e)) return !1;
      i.add(e);
      var n = H(e);
    ...
    return (
      t &&
        ...
        A(t.childNodes, function (t) {
          ...
          if (
            t &&
            "span" === (null == (r = t.tagName) ? void 0 : r.toLowerCase())
          )
            try {
              var e = R(t);
              (i = (i + " " + e).trim()),
  ...
  function at(r, n) {
    ...
    if (!E(r)) return { props: {} };
    for (
      var _ = [r], p = new Set([r]), b = r;
      b.parentNode && !S(b, "body") && L > _.length;

    )
      if (T(b.parentNode)) {
        var g = b.parentNode.host;
        if (p.has(g)) break;
        p.add(g), _.push(g), (b = g);
      } else {
        if (!E(b.parentNode)) break;
    ...
    if (
          ...
          O.push(
            (function (t, i, r, e, n) {
              ...
              P.indexOf(a) > -1 &&
                !r &&
                (s.$el_text =
                  "a" === a.toLowerCase() || "button" === a.toLowerCase()
                    ? et(1024, X(t))
                    : et(1024, R(t)));
              var o = H(t);
              o.length > 0 &&
                (s.classes = o.filter(function (t) {
                  return "" !== t;
                })),
                A(t.attributes, function (r) {
                  ...
                  if (
                    ...
                    (null == e || !e.includes(r.name)) &&
                    !i &&
                    Q(r.value) &&
                    (!d((a = r.name)) ||
                      ("_ngcontent" !== a.substring(0, 10) &&
                        "_nghost" !== a.substring(0, 7)))
                  ) {
                    var o = r.value;
      ...
      return { props: {}, explicitNoCapture: U };
    if ((c || (O[0].$el_text = S(r, "a") || S(r, "button") ? X(r) : R(r)), M)) {
      var Z, F;
      O[0].attr__href = M;
      var I =
          null ==
    ...
    return {
      props: x(
        { $event_type: u.type, $ce_version: 1 },
        { $elements: O },
        {
          $elements_chain:
            ((D = O),
              ...
              return i
                .map((i) => {
                  ...
                  var s = t(
                      ...
                      {
                        "nth-child":
                          null !== (r = i.nth_child) && void 0 !== r ? r : 0,
                        "nth-of-type":
                          null !== (e = i.nth_of_type) && void 0 !== e ? e : 0,
                      },
                      i.href ? { href: i.href } : {},
                  ...
                  return (
                    C(s)
                      .sort((t, i) => t[0].localeCompare(i[0]))
                      .forEach((t) => {
                        var i = t[1];
                ...
                return t.map((t) => {
                  var i,
                    ...
                    e = {
                      ...
                      tag_name: t.tag_name,
                      href:
                        null == (r = t.attr__href) ? void 0 : r.slice(0, 2048),
                      attr_class: rt(t),
                      attr_id: t.attr__id,
                  ...
                  return (
                    C(t)
                      .filter((t) => 0 === t[0].indexOf("attr__"))
                      .forEach((t) => (e.attributes[t[0]] = t[1])),
                    e
                  );
                });
              })(D)
        ...
        null != (a = O[0]) && a.$el_text
          ...
          : {},
        w && "click" === u.type ? { $external_click_url: w } : {},
        j
      ),
    };
  }
        ...
        d &&
          ...
          "MutationObserver" === t &&
            s(
              (o =
                null !==
                  (h = null == (f = r.navigator) ? void 0 : f.userAgent) &&
                void 0 !== h
                  ? h
                  : ""),
              "AppleWebKit"
            ...
            !s(o, "Chrome") &&
            (l.classList.add("rr-block", "ph-no-capture"), (c = !0)));
      } catch (i) {
        y.warn(
          "Could not create sandbox iframe for " +
            t +
            " check, bailing to assignableWindow." +
            t +
            ": ",
          i
        );
  ...
  function ut(i, r) {
    var e,
      ...
      a = f((e = i).target)
        ? e.srcElement || null
        : null != (n = e.target) && n.shadowRoot
        ? e.composedPath()[0] || null
        : e.target || null;
    return a
      ? t({ node: a, originalEvent: i, timestamp: Date.now() }, r)
      : null;
  }
  function lt(t, i) {
  ...
  class pt {
    me(t) {
      var i,
        ...
        o,
        u,
        l = this.ye((null == t ? void 0 : t.__onCapture) || this.ge.bind(this));
      return {
        element_attribute_ignorelist:
          null !== (i = null == t ? void 0 : t.element_attribute_ignorelist) &&
          void 0 !== i
            ? i
            : l.element_attribute_ignorelist,
        scroll_threshold_ms:
          null !== (r = null == t ? void 0 : t.scroll_threshold_ms) &&
          void 0 !== r
            ? r
            : l.scroll_threshold_ms,
        selection_change_threshold_ms:
          null !== (e = null == t ? void 0 : t.selection_change_threshold_ms) &&
          void 0 !== e
            ? e
            : l.selection_change_threshold_ms,
        mutation_threshold_ms:
          null !== (n = null == t ? void 0 : t.mutation_threshold_ms) &&
          void 0 !== n
            ? n
            : l.mutation_threshold_ms,
        capture_clicks_with_modifier_keys:
          null !==
            (a = null == t ? void 0 : t.capture_clicks_with_modifier_keys) &&
          void 0 !== a
            ? a
            : l.capture_clicks_with_modifier_keys,
        capture_dead_swipes:
          null !== (s = null == t ? void 0 : t.capture_dead_swipes) &&
          void 0 !== s
            ? s
            : l.capture_dead_swipes,
        swipe_threshold_px:
          null !== (o = null == t ? void 0 : t.swipe_threshold_px) &&
          void 0 !== o
            ? o
            : l.swipe_threshold_px,
        max_dead_swipes_per_page_load:
          null !== (u = null == t ? void 0 : t.max_dead_swipes_per_page_load) &&
          void 0 !== u
            ? u
            : l.max_dead_swipes_per_page_load,
    ...
    constructor(t, i) {
      (this.be = []),
        ...
        (this.ke = (t) => {
          var i = ut(t, { type: "click" });
          _(i) || this.xe(i) || this.Se(i), this.Ce();
        }),
        (this.Me = () => {
          var t = Date.now();
          (this._e = t),
        ...
        (this.Ee = () => {
          var t = Date.now();
          (this.Le = t), this.Ae("visibilityChangedDelayMs", t);
        }),
        (this.Re = () => {
          var t = Date.now();
          (this.Oe = t), this.Ae("focusChangedDelayMs", t);
        }),
        (this.Ne = (t) => {
          var i = t.touches,
            r = 1 === (null == i ? void 0 : i.length) ? i[0] : void 0;
          this.Fe = r
            ? { x: r.clientX, y: r.clientY, timestamp: Date.now() }
            : void 0;
        }),
        (this.De = () => {
          this.Fe = void 0;
            ...
            if (a) {
              ...
              if (
                ...
                if (
                  ...
                  (null !==
                    (c =
                      null == e || null == e.elementsFromPoint
                        ? void 0
                        : e.elementsFromPoint(r.x, r.y)) && void 0 !== c
                    ? c
                    : []
                  ).some((t) => (null == t.matches ? void 0 : t.matches(ht)))
                )
                  return;
                var h = ut(n, {
                  type: "swipe",
                ...
                _(h) || this.xe(h) || this.Se(h), this.Ce();
              }
            }
          }
        }),
    ...
    stop() {
      ...
      null == (t = this.Qe) || t.disconnect(),
        ...
        a.removeEventListener("scroll", this.Me, { capture: !0 }),
        a.removeEventListener("selectionchange", this.Te),
        a.removeEventListener("touchstart", this.Ne, { capture: !0 }),
        a.removeEventListener("touchend", this.Pe, { capture: !0 }),
        a.removeEventListener("touchcancel", this.De, { capture: !0 }),
    ...
    Ce() {
      this.be.length &&
        f(this.Ye) &&
        (this.Ye = a.setTimeout(() => {
          this.Ke();
        }, 1e3));
    }
    Ue() {
      D(a, "scroll", this.Me, { capture: !0 });
    }
    We() {
    ...
    Ze() {
      D(a, "blur", this.Re), D(a, "focus", this.Re);
    }
    Ae(t, i) {
      this.be.forEach((r) => {
    ...
    $e() {
      D(a, "touchstart", this.Ne, { capture: !0, passive: !0 }),
        D(a, "touchend", this.Pe, { capture: !0, passive: !0 }),
        D(a, "touchcancel", this.De, { capture: !0, passive: !0 });
    }
    He() {
    ...
    et(t) {
      return !(
        !(
          (r = t.node) instanceof Element &&
          ("__POSTHOG_TOOLBAR__" === r.id ||
            (null != r.closest && r.closest(".toolbar-global-fade-container")))
        ) &&
        !this.be.some(
          (i) =>
            i.type === t.type &&
            i.node === t.node &&
            1e3 > Math.abs(i.timestamp - t.timestamp)
        ) &&
        !S(t.node, "html") &&
        E(t.node) &&
        (function (t, r) {
          ...
          if (!i || F(t)) return !1;
          var n =
            "[object Boolean]" === c.call(r)
              ? Z
              : null !== (e = null == r ? void 0 : r.css_selector_ignorelist) &&
                void 0 !== e
              ? e
              : Z;
          return !(function (t, i) {
            ...
            for (var n of t) if ((r = e(n))) return r.v;
            return !1;
          })(I(t).targetElementList, n);
        })(t.node, { css_selector_ignorelist: this.qe.css_selector_ignorelist })
      );
      var r;
    }
    tt(t) {
      return (
        !(
          this.qe.capture_clicks_with_modifier_keys ||
          ((r = t.originalEvent),
          !(r.ctrlKey || r.metaKey || r.altKey || r.shiftKey))
        ) ||
        !!this.et(t) ||
        ((e = t.node),
    ...
    Ke() {
      if (this.be.length) {
        ...
        var t = this.be;
        for (var i of ((this.be = []), t)) {
          var r;
          (i.mutationDelayMs =
            null !== (r = i.mutationDelayMs) && void 0 !== r
              ? r
              : this.je && this.je >= i.timestamp
              ? this.je - i.timestamp
              : void 0),
            (i.absoluteDelayMs = Date.now() - i.timestamp),
            (i.selectionChangedDelayMs =
              this.Ie && this.Ie >= i.timestamp
                ? this.Ie - i.timestamp
                : void 0);
          var e = ft(i.scrollDelayMs, this.qe.scroll_threshold_ms),
            n = ft(
              i.selectionChangedDelayMs,
              this.qe.selection_change_threshold_ms
            ),
            a = ft(i.mutationDelayMs, this.qe.mutation_threshold_ms),
            s = ft(i.absoluteDelayMs, 1.1 * this.qe.mutation_threshold_ms),
            o =
              b(i.scrollDelayMs) &&
              this.qe.scroll_threshold_ms > i.scrollDelayMs,
            u =
              b(i.mutationDelayMs) &&
              this.qe.mutation_threshold_ms > i.mutationDelayMs,
            l =
              b(i.selectionChangedDelayMs) &&
              this.qe.selection_change_threshold_ms > i.selectionChangedDelayMs,
          ...
          if (!(o || u || l || c || h))
            if (e || a || s || n) {
              var v = ct(i);
              if ("$dead_swipe" === v) {
                if (this.we >= this.qe.max_dead_swipes_per_page_load) continue;
                this.we++;
              }
              this._onCapture(i, {
              ...
              this.qe.mutation_threshold_ms > i.absoluteDelayMs &&
                this.be.push(i);
        }
        this.Ce();
      }
  ...
  (a.__PosthogExtensions__ = a.__PosthogExtensions__ || {}),
    (a.__PosthogExtensions__.initDeadClicksAutocapture = (t, i) =>
      new pt(t, i));
})();
